...
describe('React i18n integration', () => {
  ...
  it('keeps unknown caller label language independent of translated menu chrome', async () => {
    ...
    editors.push(editor);
    await update(() => { root.render(<><DomternalToolbar editor={editor} /><DomternalBubbleMenu editor={editor} items={['caller-button', 'caller-dropdown']} /><DomternalFloatingMenu editor={editor} /></>); });
    await update(() => {
